...
<?php
    ...
    <div class="span5">
        <div class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="inputTitle" name="inputTitle" placeholder="Title" value="<?= $gallery['title']?>">
                </div>
            </div>
            <div class="control-group">
    ...
    <div class="span5">
        <div id="error"></div>
        <div id="frame_photo"><img id='uploadedImage' class='img-polaroid' width='250' src='<?= base_url('uploaded/gallery/'.md5($gallery['id_gallery']).".jpg?d=".date('YmdHis'))?>' /></div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function submit(){
            ...
            var id_gallery  = <?= $gallery['id_gallery']?>

            $.ajax({
                type		: 'post',
                url			: '<?= site_url('cms/updateimage')?>',
                data		: {
